package com.xyw.datacollectsystem.network;
...
import com.xyw.datacollectsystem.utils.OnDownloadListener;
...
public class Downloader {
    private int downloadedSize = 0;//已下载
    private int fileSize = 0;//文件大小
    private int downloadThreadNum = 5;//分配线程数
    private String downloadUrl = "";//下载地址
    private String downloadFilePath = "";//文件保存路径
                ...
                while (!finished) {
                    ...
                    if (finished) {// 下载完成返回
                        ...
                        if (isReturnByteData) {
                            ...
                            message1 = handler.obtainMessage(DOWNLOAD_COMPLETED, baos1.toByteArray());
                            handler.sendMessage(message1);
                        } else {
                            message1 = handler.obtainMessage(DOWNLOAD_COMPLETED, null);
                            handler.sendMessage(message1);
                        }
                        break;
    ...
    class FileDownloadThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                //if (Parameters.DEBUG) System.out.println(getName() + " Error:" + e.getMessage());
                this.finished = true;
            }
        }
